...
- release: force-push bot-managed release branch
- release: configure git identity for release commit
- release: quote both if expressions to fix YAML parse
- release: wrap negated if expression in ${{ }} to fix YAML parse
