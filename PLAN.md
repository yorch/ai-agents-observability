...
Tasks P2-001–P2-010 are fully decomposed and implemented. See [`tasks/INDEX.md`](./tasks/INDEX.md) for current status. P2-001 (GitHub App credentials wiring) remains in review; all other P2 tasks, including P2-010 (GHES integration test), are done.
...
**Done.** Reconciled 2026-08-18 and closed 2026-08-20. Turns the heuristic `/org/models` routing card into a defensible, governed, persona-appropriate optimization capability grounded in the per-agent price tables. Ranked #1 by impact-to-effort in [`OPPORTUNITIES.md`](./OPPORTUNITIES.md) §4.
