...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('VIEW_SESSION', 'VIEW_TRANSCRIPT', 'EXPORT_TEAM', 'EXPORT_ORG', 'ADMIN_IMPERSONATE', 'DELETE_REQUEST', 'HOOK_TOKEN_ISSUED', 'ROLE_GRANT', 'RETENTION_OVERRIDE_CHANGED', 'GRANT_REQUESTED', 'GRANT_APPROVED', 'GRANT_REVOKED', 'ALERT_ACKNOWLEDGED', 'ALERT_SILENCED', 'JUDGE_READ_TRANSCRIPT', 'MODEL_POLICY_CHANGED', 'HOOK_TOKEN_REVOKED', 'ADMIN_JOB_TRIGGERED', 'ADMIN_JOB_CONFIG_CHANGED');
